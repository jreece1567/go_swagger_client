...
type TransactionResponse struct {
	...
	Required: true
	*/
	Data *TransactionInstance `json:"data"`
...
func (m *TransactionResponse) validateErrors(formats strfmt.Registry) error {

	return nil
}

func (m *TransactionResponse) validateMeta(formats strfmt.Registry) error {
