...
/*SearchDealResult search deal result

swagger:model SearchDealResult
*/
type SearchDealResult struct {
...
// Validate validates this search deal result
func (m *SearchDealResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SearchDealResult) validateFacets(formats strfmt.Registry) error {

	return nil
}

func (m *SearchDealResult) validateHits(formats strfmt.Registry) error {
...
func (m *SearchDealResult) validateHitsPerPage(formats strfmt.Registry) error {
...
func (m *SearchDealResult) validateIndex(formats strfmt.Registry) error {
...
func (m *SearchDealResult) validateNbHits(formats strfmt.Registry) error {
...
func (m *SearchDealResult) validateNbPages(formats strfmt.Registry) error {
...
func (m *SearchDealResult) validatePage(formats strfmt.Registry) error {
...
func (m *SearchDealResult) validateParams(formats strfmt.Registry) error {
...
func (m *SearchDealResult) validateProcessingTimeMS(formats strfmt.Registry) error {
...
func (m *SearchDealResult) validateQuery(formats strfmt.Registry) error {
