...
/*SearchEventResult search event result

swagger:model SearchEventResult
*/
...
// Validate validates this search event result
func (m *SearchEventResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SearchEventResult) validateFacets(formats strfmt.Registry) error {

	return nil
}

func (m *SearchEventResult) validateHits(formats strfmt.Registry) error {
...
func (m *SearchEventResult) validateHitsPerPage(formats strfmt.Registry) error {
...
func (m *SearchEventResult) validateIndex(formats strfmt.Registry) error {
...
func (m *SearchEventResult) validateNbHits(formats strfmt.Registry) error {
...
func (m *SearchEventResult) validateNbPages(formats strfmt.Registry) error {
...
func (m *SearchEventResult) validatePage(formats strfmt.Registry) error {
...
func (m *SearchEventResult) validateParams(formats strfmt.Registry) error {
...
func (m *SearchEventResult) validateProcessingTimeMS(formats strfmt.Registry) error {
...
func (m *SearchEventResult) validateQuery(formats strfmt.Registry) error {
