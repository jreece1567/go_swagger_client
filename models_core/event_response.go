...
/*EventResponse Information about a specific event
...
func (m *EventResponse) validateErrors(formats strfmt.Registry) error {

	return nil
}

func (m *EventResponse) validateMeta(formats strfmt.Registry) error {
