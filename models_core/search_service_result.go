...
/*SearchServiceResult search service result

swagger:model SearchServiceResult
*/
...
// Validate validates this search service result
func (m *SearchServiceResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SearchServiceResult) validateFacets(formats strfmt.Registry) error {

	return nil
}

func (m *SearchServiceResult) validateHits(formats strfmt.Registry) error {
...
func (m *SearchServiceResult) validateHitsPerPage(formats strfmt.Registry) error {
...
func (m *SearchServiceResult) validateIndex(formats strfmt.Registry) error {
...
func (m *SearchServiceResult) validateNbHits(formats strfmt.Registry) error {
...
func (m *SearchServiceResult) validateNbPages(formats strfmt.Registry) error {
...
func (m *SearchServiceResult) validatePage(formats strfmt.Registry) error {
...
func (m *SearchServiceResult) validateParams(formats strfmt.Registry) error {
...
func (m *SearchServiceResult) validateProcessingTimeMS(formats strfmt.Registry) error {
...
func (m *SearchServiceResult) validateQuery(formats strfmt.Registry) error {
