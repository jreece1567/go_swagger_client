...
/*DirectoryCreateBody Data to create a directory.

swagger:model directoryCreateBody
*/
...
// Validate validates this directory create body
func (m *DirectoryCreateBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DirectoryCreateBody) validateCategoryIds(formats strfmt.Registry) error {
...
func (m *DirectoryCreateBody) validateFeatures(formats strfmt.Registry) error {
...
var directoryCreateBodyLanguagesItemsEnum []interface{}

func (m *DirectoryCreateBody) validateLanguagesItemsEnum(path, location string, value string) error {
	if directoryCreateBodyLanguagesItemsEnum == nil {
		var res []string
		if err := json.Unmarshal([]byte(`["en_US","en_GB","es_ES","fr_FR","it_IT","de_DE","pt_PT","ja_JP","zh_CN","ar_SA","he_IL","ru_RU"]`), &res); err != nil {
			return err
		}
		for _, v := range res {
			directoryCreateBodyLanguagesItemsEnum = append(directoryCreateBodyLanguagesItemsEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, directoryCreateBodyLanguagesItemsEnum); err != nil {
		return err
	}
	return nil
}

func (m *DirectoryCreateBody) validateLanguages(formats strfmt.Registry) error {
