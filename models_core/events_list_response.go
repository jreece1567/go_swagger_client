...
func (m *EventsListResponse) validateData(formats strfmt.Registry) error {
...
func (m *EventsListResponse) validateErrors(formats strfmt.Registry) error {

	return nil
}

func (m *EventsListResponse) validateMeta(formats strfmt.Registry) error {
