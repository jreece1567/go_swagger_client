...
/*SearchProductResult search product result

swagger:model SearchProductResult
*/
...
// Validate validates this search product result
func (m *SearchProductResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SearchProductResult) validateFacets(formats strfmt.Registry) error {

	return nil
}

func (m *SearchProductResult) validateHits(formats strfmt.Registry) error {
...
func (m *SearchProductResult) validateHitsPerPage(formats strfmt.Registry) error {
...
func (m *SearchProductResult) validateIndex(formats strfmt.Registry) error {
...
func (m *SearchProductResult) validateNbHits(formats strfmt.Registry) error {
...
func (m *SearchProductResult) validateNbPages(formats strfmt.Registry) error {
...
func (m *SearchProductResult) validatePage(formats strfmt.Registry) error {
...
func (m *SearchProductResult) validateParams(formats strfmt.Registry) error {
...
func (m *SearchProductResult) validateProcessingTimeMS(formats strfmt.Registry) error {
...
func (m *SearchProductResult) validateQuery(formats strfmt.Registry) error {
