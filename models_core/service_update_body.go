...
/*ServiceUpdateBody Service update parameters in message body
...
func (m *ServiceUpdateBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceUpdateBody) validateHours(formats strfmt.Registry) error {
...
func (m *ServiceUpdateBody) validateLocations(formats strfmt.Registry) error {
...
func (m *ServiceUpdateBody) validateRates(formats strfmt.Registry) error {
