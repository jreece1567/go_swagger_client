...
// WithCentreID adds the centreId to the get search services params
func (o *GetSearchServicesParams) WithCentreID(CentreID *string) *GetSearchServicesParams {
	o.CentreID = CentreID
	return o
}

// WithCountry adds the country to the get search services params
func (o *GetSearchServicesParams) WithCountry(Country *string) *GetSearchServicesParams {
	o.Country = Country
	return o
}

// WithDebug adds the debug to the get search services params
func (o *GetSearchServicesParams) WithDebug(Debug *bool) *GetSearchServicesParams {
	o.Debug = Debug
	return o
}

// WithExcludeFromSearch adds the excludeFromSearch to the get search services params
func (o *GetSearchServicesParams) WithExcludeFromSearch(ExcludeFromSearch []string) *GetSearchServicesParams {
	o.ExcludeFromSearch = ExcludeFromSearch
	return o
}

// WithFields adds the fields to the get search services params
func (o *GetSearchServicesParams) WithFields(Fields []string) *GetSearchServicesParams {
	o.Fields = Fields
	return o
}
...
// WithMaxValuesPerFacet adds the maxValuesPerFacet to the get search services params
func (o *GetSearchServicesParams) WithMaxValuesPerFacet(MaxValuesPerFacet *int64) *GetSearchServicesParams {
	o.MaxValuesPerFacet = MaxValuesPerFacet
	return o
}

// WithPage adds the page to the get search services params
func (o *GetSearchServicesParams) WithPage(Page *int64) *GetSearchServicesParams {
	o.Page = Page
	return o
}

// WithTerm adds the term to the get search services params
func (o *GetSearchServicesParams) WithTerm(Term *string) *GetSearchServicesParams {
	o.Term = Term
	return o
}
